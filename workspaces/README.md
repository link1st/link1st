...
## 导读
- 随着 2020 年 3 月 15 日 go 1.18 正式发布，新版本除了对性能的提升之外，还引入了很多新功能，其中就有 go 期盼已久的功能泛型(Generics)，同时还引入的多模块工作区(Workspaces)和模糊测试(Fuzzing)。
...
- [Go 多模块工作区文档、代码示例获取地址](https://github.com/link1st/link1st/tree/master/workspaces) https://github.com/link1st/link1st/tree/master/workspaces
